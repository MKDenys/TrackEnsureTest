...
public class InsertGasStationAsyncTask extends AsyncTask<GasStation, Void, Void> {

    private GasStationDao gasStationDao;

    public InsertGasStationAsyncTask(GasStationDao gasStationDao) {
        this.gasStationDao = gasStationDao;
    }

    @Override
    protected Void doInBackground(GasStation... gasStations) {
        this.gasStationDao.insert(gasStations);
        return null;
    }
}
